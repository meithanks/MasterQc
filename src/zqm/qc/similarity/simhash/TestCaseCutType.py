...
#    '''SimHash TestCase'''
    ...
    TCase=TestCase(filename,'SH-Jieba',4,'Jieba')
    TCase.saveSimPiraTxts()
    
    TCase=TestCase(filename,'SH-Standard',5,'Standard')
    TCase.saveSimPiraTxts()
    
    TCase=TestCase(filename,'SH-NLP',6,'NLP')
    TCase.saveSimPiraTxts()
    
    
    TCase=TestCase(filename,'SH-Index',7,'Index')
    TCase.saveSimPiraTxts()
    
    
    TCase=TestCase(filename,'SH-Speed',8,'Speed')
    TCase.saveSimPiraTxts()
   
    TCase=TestCase(filename,'SH-NShort',9,'NShort')
    TCase.saveSimPiraTxts()
    
    TCase=TestCase(filename,'SH-Short',10,'Short')
    TCase.saveSimPiraTxts()
    
    TCase=TestCase(filename,'SH-CRF',11,'CRF')
    TCase.saveSimPiraTxts()
    print "测试结束"
